            ...
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">Artikel</h4><span class="text-muted mt-1 tx-13 ms-2 mb-0">/
                        Data Kategori Artikel</span>
                </div>
            </div>
            <div class="d-flex my-xl-auto right-content">
                <div class="pe-1 mb-xl-0">
                    <a href="/dashboard/category-articles/create" class="btn btn-primary">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">Data Kategori Artikel</h4>
                            <i class="mdi mdi-dots-horizontal text-gray"></i>
                        </div>
                        <p class="tx-12 tx-gray-500 mb-2">Semua data Kategori Artikel</a></p>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($categoryArticles as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->slug }}</td>
                                            <td class="d-flex">
                                                <a onclick='modal_konfir("/dashboard/category-articles/{{ $item->id }}")'
