        ...
        <div class="row row-sm">
            <div class="col-xl-12">
                <div class="card card-body pd-20 pd-md-40 border shadow-none">
                    <h5 class="card-title mg-b-20">Tambah Artikel</h5>
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <select class="form-control @error('category_article_id') is-invalid @enderror select2"
                                            name="category_article_id">
                                            <option value="">Pilih Kategori</option>
                                            @foreach ($categories as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('category_article_id') ? 'selected' : '' }}>
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
