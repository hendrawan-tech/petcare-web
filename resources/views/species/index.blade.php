            ...
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">Pasien</h4><span class="text-muted mt-1 tx-13 ms-2 mb-0">/
                        Data Species Pasien</span>
                </div>
            </div>
            <div class="d-flex my-xl-auto right-content">
                <div class="pe-1 mb-xl-0">
                    <a href="/dashboard/species/create" class="btn btn-primary">
                        <i class="mdi mdi-plus me-2"></i>
                        Tambah Species Pasien
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">Data Species Pasien</h4>
                            <i class="mdi mdi-dots-horizontal text-gray"></i>
                        </div>
                        <p class="tx-12 tx-gray-500 mb-2">Semua data Species Pasien</a></p>
                    </div>
                    <div class="card-body">
                                    ...
                                    @foreach ($species as $item)
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-center">
                                                ...
                                                <a onclick='modal_konfir("/dashboard/species/{{ $item->id }}")'
