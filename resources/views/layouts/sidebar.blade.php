...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ Auth::user()->avatar ? asset('upload/' . Auth::user()->avatar) : asset('assets/img/faces/6.jpg') }}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/dashboard/transactions') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path d="M13 4H6v16h12V9h-5V4zm3 14H8v-2h8v2zm0-6v2H8v-2h8z" opacity=".3" />
                        <path
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/dashboard/users') }}">
                    ...
                    <span class="side-menu__label">Daftar Dokter</span>
                </a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/dashboard/practice-schedules') }}">
                    ...
                    <span class="side-menu__label">Jadwal Dokter</span>
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/dashboard/patients') }}">
                    ...
                    <span class="side-menu__label">Daftar Pasien</span>
                </a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/dashboard/species') }}">
                    ...
                    <span class="side-menu__label">Daftar Spesies</span>
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/dashboard/articles') }}">
                    ...
                    <span class="side-menu__label">Daftar Artikel</span>
                </a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/dashboard/category-articles') }}">
                    ...
                    <span class="side-menu__label">Kategori Artikel</span>
                </a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/dashboard/category-products') }}">
                    ...
                    <span class="side-menu__label">Kategori Produk</span>
                </a>
            </li>
