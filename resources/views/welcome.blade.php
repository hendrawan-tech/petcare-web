...
<!-- Mirrored from appbeats.themetags.com/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Dec 2022 13:01:50 GMT -->
...
<head>
    ...
    <meta property="og:site_name" content="Bontang Petcare" /> <!-- website name -->
    <meta property="og:site" content="Bontang Petcare" /> <!-- website link -->
    <meta property="og:title" content="Bontang Petcare" /> <!-- title shown in the actual shared post -->
    ...
    <!--title-->
    <title>Bontang Petcare</title>

    <!--favicon icon-->
    <link rel="icon" href="{{ asset('assets/img/brand/favicon.png') }}" type="image/png" sizes="16x16">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg fixed-top bg-transparent">
            <div class="container">
                <a class="navbar-brand" href="index-3.html">
                    <img src="{{ asset('assets/frontend/img/logo-white.png') }}" width="160" alt="logo"
                        class="img-fluid" />
                </a>
                    ...
                    <ul class="navbar-nav ml-auto menu">
                        <li class="dropdown"><a href="#" class="dropdown-toggle"> Home</a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="index-7.html">Home Page 07 <span
                                            class="badge color-1 color-1-bg custom-badge"> New</span></a></li>
                                <li><a href="index-8.html">Home Page 08 <span
                                            class="badge color-1 color-1-bg custom-badge"> New</span></a></li>
                                <li><a href="index-9.html">Home Page 09 <span
                                            class="badge color-1 color-1-bg custom-badge"> New</span></a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="#" class="dropdown-toggle">Pages</a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="#">Teams <span class="badge color-1 color-1-bg custom-badge">
                                            New</span></a>
                                    <ul class="sub-menu">
                                ...
                                <li><a href="#">Our Blog <span class="badge color-1 color-1-bg custom-badge">
                                            New</span></a>
                                    <ul class="sub-menu">
                                ...
                                <li><a href="partner.html">Our Partner <span
                                            class="badge color-1 color-1-bg custom-badge">New</span></a></li>
                                <li><a href="project-details.html">Project Details <span
                                            class="badge color-1 color-1-bg custom-badge">New</span></a></li>
                                <li><a href="services-details.html">Services Details <span
                                            class="badge color-1 color-1-bg custom-badge">New</span></a></li>
    ...
    <div class="main">
        ...
        <section class="hero-equal-height ptb-100 gradient-overlay"
            style="background: url('{{ asset('assets/frontend/img/galaxy-image.jpg') }}')no-repeat center center / cover">
            <div class="container">
            ...
            <div class="shape-bottom overflow-hidden">
                <img src="{{ asset('assets/frontend/img/hero-shape.svg') }}" alt="shape" class="bottom-shape">
            </div>
        </section>
        <!--hero section end-->
                ...
                <div class="row">
                    <div class="col-md-8 col-lg-8">
                        <div class="section-heading mb-5">
                            ...
                            <p>We will helps you to build beautiful websites that stand out and automatically adapt to
                                your style. Assertively envisioneer standardized portals with high standards in results.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex align-items-start mb-sm-0 mb-md-5 mb-lg-5">
                                    <span
                                        class="ti-face-smile icon-sm color-1 color-1-bg p-3 mr-4 mt-1 rounded"></span>
                                    <div class="icon-text">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex align-items-start mb-sm-0 mb-md-5 mb-lg-5">
                                    <span
                                        class="ti-layout-media-right icon-sm color-4 color-4-bg p-3 mr-4 mt-1 rounded"></span>
                                    <div class="icon-text">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-start mb-sm-0 mb-md-5 mb-lg-5">
                                    <span
                                        class="ti-layout-cta-right icon-sm color-3 color-3-bg p-3 mr-4 mt-1 rounded"></span>
                                    <div class="icon-text">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="feature-content-wrap">
                            <ul class="nav nav-tabs feature-tab justify-content-center border-bottom-0"
                                data-tabs="tabs">
                                <li class="nav-item">
                                    <a class="nav-link active h6 d-flex align-items-center" href="#tab6-1"
                                        data-toggle="tab">
                                        <span class="ti-vector d-inline-block color-1 mr-2 icon-sm p-1"></span>
                                        Generate Ideas
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link h6 d-flex align-items-center" href="#tab6-2"
                                        data-toggle="tab">
                                        <span
                                            class="ti-layout-list-thumb d-inline-block color-2 mr-2 icon-sm p-1"></span>
                                        Collect Contents
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link h6 d-flex align-items-center" href="#tab6-3"
                                        data-toggle="tab">
                                        <span class="ti-palette d-inline-block color-3 mr-2 icon-sm p-1"></span>
                                        Create Design
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link h6 d-flex align-items-center" href="#tab6-4"
                                        data-toggle="tab">
                                        <span class="ti-cup d-inline-block color-4 mr-2 icon-sm p-1"></span>
                                        Launch Project
                                    </a>
                                </li>
                            </ul>
                                    ...
                                    <div class="row align-items-center justify-content-between pt-5">
                                        <div class="col-md-5 col-lg-4">
                                            <div class="tab-content-wrap">
                                                <span
                                                    class="h1 display-3 color-secondary font-weight-bold mb-3 d-block">01.</span>
                                                <h3>Fully Branded Portal</h3>
                                                <p>Assertively incentivize long-term high-impact scenarios whereas
                                                    accurate
                                                    imperatives.</p>
                                                <p>Quickly communicate multimedia based materials for enabled channels.
                                                    Seamlessly disintermediate robust best practices for B2C e-tailers.
                                                    Efficiently procrastinate prospective experiences.</p>
                                                <a href="#" class="mt-3 d-flex align-items-center">Learn more
                                                    about this
                                                    <span class="ti-angle-right ml-2"></span></a>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-7">
                                            <div class="img-wrap">
                                                <img src="{{ asset('assets/frontend/img/dasboard-screen-1.png') }}"
                                                    alt="feature" class="img-fluid rounded" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab6-2">
                                    <div class="row align-items-center justify-content-between pt-5">
                                        <div class="col-md-5 col-lg-4">
                                            <div class="tab-content-wrap">
                                                <span
                                                    class="h1 display-3 color-secondary font-weight-bold mb-3 d-block">02.</span>
                                                <h3>Returns to Exchanges</h3>
                                                <p>Quickly communicate multimedia based materials for enabled channels.
                                                    Turn
                                                    Returns to Exchanges Seamlessly disintermediate robust best
                                                    practices
                                                    for B2C e-tailers. Efficiently procrastinate prospective
                                                    experiences.</p>
                                                <p>Dramatically reconceptualize user-centric expertise whereas
                                                    competitive
                                                    synergy.</p>
                                                <a href="#" class="mt-3 d-flex align-items-center">Learn more
                                                    about this
                                        ...
                                        <div class="col-md-6 col-lg-7">
                                            <div class="img-wrap">
                                                <img src="{{ asset('assets/frontend/img/dasboard-screen-3.png') }}"
                                                    alt="feature" class="img-fluid rounded" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="tab6-3">
                                    <div class="row align-items-center justify-content-between pt-5">
                                        <div class="col-md-5 col-lg-4">
                                            <div class="tab-content-wrap">
                                                <span
                                                    class="h1 display-3 color-secondary font-weight-bold mb-3 d-block">03.</span>
                                                <h3>Multichannel Returns</h3>
                                                <p>Quickly communicate multimedia based materials to team driven
                                                    infrastructures. Seamlessly disintermediate robust best practices
                                                    for
                                                    B2C e-tailers. Efficiently procrastinate prospective experiences.
                                                </p>
                                                <p>Competently disintermediate web-enabled growth strategies whereas
                                        ...
                                        <div class="col-md-6 col-lg-7">
                                            <div class="img-wrap">
                                                <img src="{{ asset('assets/frontend/img/dasboard-screen-4.png') }}"
                                                    alt="feature" class="img-fluid rounded" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="tab6-4">
                                    <div class="row align-items-center justify-content-between pt-5">
                                        <div class="col-md-5 col-lg-4">
                                            <div class="tab-content-wrap">
                                                <span
                                                    class="h1 display-3 color-secondary font-weight-bold mb-3 d-block">04.</span>
                                                <h3>Set goals & timelines</h3>
                                                <p>Quickly communicate multimedia based materials for enabled channels.
                                                    Seamlessly disintermediate robust best practices for B2C e-tailers.
                                                    Efficiently procrastinate prospective experiences.</p>
                                                <p>Continually architect multifunctional schemas rather than superior
                                                    users.
                                                    Conveniently scale.</p>
                                                <a href="#" class="mt-3 d-flex align-items-center">Learn more
                                                    about this
                                                    <span class="ti-angle-right ml-2"></span></a>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-lg-7">
                                            <div class="img-wrap">
                                                <img src="{{ asset('assets/frontend/img/dasboard-screen-5.png') }}"
                                                    alt="feature" class="img-fluid rounded" />
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                        <div class="section-heading text-center mb-5">
                            ...
                            <p>Credibly synthesize multimedia based networks vis-a-vis top-line growth strategies.
                                Continually leverage existing worldwide interfaces </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="screen-slider-content">
                    ...
                    <div class="screen-carousel owl-carousel owl-theme dot-indicator">
                        <img src="{{ asset('assets/frontend/img/01.png') }}" class="img-fluid" alt="screenshots" />
                        <img src="{{ asset('assets/frontend/img/02.png') }}" class="img-fluid" alt="screenshots" />
                        <img src="{{ asset('assets/frontend/img/03.png') }}" class="img-fluid" alt="screenshots" />
                        <img src="{{ asset('assets/frontend/img/04.png') }}" class="img-fluid" alt="screenshots" />
                        <img src="{{ asset('assets/frontend/img/05.png') }}" class="img-fluid" alt="screenshots" />
                        <img src="{{ asset('assets/frontend/img/06.png') }}" class="img-fluid" alt="screenshots" />
                    </div>
                </div>
        ...
        <section id="download" class="gradient-overlay"
            style="background: url('{{ asset('assets/frontend/img/hero-bg-3.jpg') }}')no-repeat center center / cover">
            <div class="container">
                <div class="row justify-content-around align-items-end">
                    <div class="col-md-6 col-lg-5">
                        <div class="download-txt text-white ptb-100">
                            ...
                            <p class="lead">Conveniently transform frictionless mindshare after orthogonal
                                manufactured
                                products.</p>
                            <div class="action-btns download-btn mt-4">
                                <a href="#" class="btn solid-white-btn mr-3"> <span
                                        class="ti-apple mr-2"></span> App Store</a>
                                <a href="#" class="btn outline-white-btn"> <span
                                        class="ti-android mr-2"></span> Play Store</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-7">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4">
                        <div class="testimonial-single shadow-sm gray-light-bg rounded p-4">
                            ...
                            <div class="client-ratting mt-2">
                                ...
                                <h6 class="font-weight-bold">5.0 <small class="font-weight-lighter">BizBite</small>
                                </h6>
                            </div>
                        </div>
                        <div class="client-info-wrap d-flex align-items-center mt-5">
                            <div class="client-img mr-3">
                                <img src="{{ asset('assets/frontend/img/client-1.jpg') }}" alt="client"
                                    width="60" class="img-fluid rounded-circle shadow-sm" />
                            </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        ...
                        <div class="client-info-wrap d-flex align-items-center mt-5">
                            <div class="client-img mr-3">
                                <img src="{{ asset('assets/frontend/img/client-2.jpg') }}" alt="client"
                                    width="60" class="img-fluid rounded-circle shadow-sm" />
                            </div>
                            <div class="client-info">
                    ...
                    <div class="col-md-4 col-lg-4">
                        ...
                        <div class="client-info-wrap d-flex align-items-center mt-5">
                            <div class="client-img mr-3">
                                <img src="{{ asset('assets/frontend/img/client-3.jpg') }}" alt="client"
                                    width="60" class="img-fluid rounded-circle shadow-sm" />
                            </div>
                            <div class="client-info">
                ...
                <div class="row align-items-center justify-content-around">
                    <div class="col-md-12 col-lg-4">
                        <div class="section-heading mb-5">
                            ...
                            <p class="lead">Monotonectally mesh visionary supply chains before plug-and-play
                                interfaces.
                                Globally benchmark worldwide information after clicks-and-mortar channels.</p>
                        </div>
                        <ul class="nav nav-tabs feature-tab pricing-tab border-bottom-0 mb-md-5 mb-lg-0"
                            data-tabs="tabs">
                            <li class="nav-item">
                                <a class="nav-link active h6 d-flex align-items-center" href="#monthly"
                                    data-toggle="tab">
                                    Monthly
                                </a>
                            </li>
                                        ...
                                        <div class="card text-center single-pricing-pack">
                                            ...
                                            <div class="card-header py-4 border-0 pricing-header">
                                                <div class="h1 text-center mb-0">$<span
                                                        class="price font-weight-bolder">19</span></div>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <a href="#" class="btn outline-btn mb-3"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="card popular-price text-center single-pricing-pack">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="#" class="btn solid-btn mb-3" target="_blank">Purchase
                                                    now</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="card text-center single-pricing-pack">
                                            ...
                                            <div class="card-header py-4 border-0 pricing-header">
                                                <div class="h1 text-center mb-0">$<span
                                                        class="price font-weight-bolder">199</span></div>
                                            </div>
                                            <div class="card-body">
                                                <ul class="list-unstyled text-sm mb-4 pricing-feature-list">
                                                    <li>Push Notifications</li>
                        ...
                        <div id="accordion" class="accordion">
                            <div class="card mb-0">
                                <a class="card-header collapsed" data-toggle="collapse" href="#collapseOne">
                                    <h6 class="mb-0 d-inline-block"><span class="ti-receipt mr-3"></span> Which
                            ...
                            <div class="card mb-0">
                                <a class="card-header collapsed" data-toggle="collapse" href="#collapseTwo">
                                    <h6 class="mb-0 d-inline-block"><span class="ti-gallery mr-3"></span> How do I get
                                        access to a
                                        theme?</h6>
                                </a>
                            ...
                            <div class="card mb-0">
                                <a class="card-header collapsed" data-toggle="collapse" href="#collapseThree">
                                    <h6 class="mb-0 d-inline-block"><span class="ti-wallet mr-3"></span> How do I see
                                        previous orders?
                                    </h6>
                                </a>
                    ...
                    <div class="col-md-12">
                        <div class="owl-carousel owl-theme clients-carousel dot-indicator">
                            <div class="item single-client">
                                <img src="{{ asset('assets/frontend/img/clients-logo-01.png') }}" alt="client logo"
                                    class="img-fluid client-img">
                            </div>
                            <div class="item single-client">
                                <img src="{{ asset('assets/frontend/img/clients-logo-02.png') }}" alt="client logo"
                                    class="img-fluid client-img">
                            </div>
                            <div class="item single-client">
                                <img src="{{ asset('assets/frontend/img/clients-logo-03.png') }}" alt="client logo"
                                    class="img-fluid client-img">
                            </div>
                            <div class="item single-client">
                                <img src="{{ asset('assets/frontend/img/clients-logo-04.png') }}" alt="client logo"
                                    class="img-fluid client-img">
                            </div>
                            <div class="item single-client">
                                <img src="{{ asset('assets/frontend/img/clients-logo-05.png') }}" alt="client logo"
                                    class="img-fluid client-img">
                            </div>
                            <div class="item single-client">
                                <img src="{{ asset('assets/frontend/img/clients-logo-06.png') }}" alt="client logo"
                                    class="img-fluid client-img">
                            </div>
                            <div class="item single-client">
                                <img src="{{ asset('assets/frontend/img/clients-logo-07.png') }}" alt="client logo"
                                    class="img-fluid client-img">
                            </div>
                            <div class="item single-client">
                                <img src="{{ asset('assets/frontend/img/clients-logo-08.png') }}" alt="client logo"
                                    class="img-fluid client-img">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-around">
                    ...
                    <div class="col-md-5">
                        <div class="contact-us-content">
                            ...
                            <p class="lead">Seamlessly deliver pandemic e-services and next-generation initiatives.
                            </p>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="footer-nav-wrap text-white mb-0 mb-md-4 mb-lg-0">
                            <a class="d-block" href="#"><img
                                    src="{{ asset('assets/frontend/img/logo-white.png') }}" alt="footer logo"
                                    width="150" class="img-fluid mb-1"></a>
                            <p>Intrinsicly matrix high standards in niches whereas intermandated niche markets.
                                Objectively harness competitive resources.</p>
        ...
        <div class="footer-bottom gray-light-bg py-3">
            <div class="container">
                <div class="row text-center justify-content-center">
                    <div class="col-md-6 col-lg-5">
                        <p class="copyright-text pb-0 mb-0">Copyright © 2022 <a href="#">Petcare</a>. Designed
                            by <a href="#">C3</a> All rights
                            reserved.</p>
                    </div>
                </div>
            </div>
