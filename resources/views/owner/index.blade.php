        ...
        <div class="breadcrumb-header justify-content-between">
            ...
            <div class="d-flex my-xl-auto right-content">
                <div class="pe-1 mb-xl-0">
                    <a href="/dashboard/owners/create" class="btn btn-primary">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">Data Owner</h4>
                            <i class="mdi mdi-dots-horizontal text-gray"></i>
                        </div>
                        <p class="tx-12 tx-gray-500 mb-2">Semua data Owner</a></p>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($users as $item)
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a onclick='modal_konfir("/dashboard/owners/{{ $item->id }}")'
